...
function Erfarenhet() {
  return (
    <>
      {/* === SEO-meta för sidan /recension === */}
      <title>Recension av Value Betting – Min erfarenhet med RebelBetting</title>
      <meta
        name="description"
        content="Läs min personliga recension av value betting och RebelBetting. Jag berättar hur jag byggt stabil avkastning varje månad och vad som krävs för att lyckas långsiktigt."
      />
      <meta
        name="keywords"
        content="rebelbetting recension, value betting erfarenhet, value betting resultat, slå spelbolagen, sportsbetting, bankroll management"
      />

      {/* 🔹 Open Graph (för delning på sociala medier) */}
      <meta property="og:title" content="Recension av Value Betting – Min erfarenhet med RebelBetting" />
      <meta
        property="og:description"
        content="Jag delar min egen erfarenhet av value betting med RebelBetting – strategier, resultat och tips för att bygga stabil avkastning varje månad."
      />
      <meta property="og:type" content="article" />
      <meta property="og:image" content="/images/Recension-bild.png" />
      <meta property="og:url" content="https://profitplay.se/recension" />
