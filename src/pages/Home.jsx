    ...
    <div className="home-page">
      <section className="intro">
        ...
        <p>
          ...
          Är du som 99% av befolkningen och inte kan räkna ut sannolikheten på egen hand? Inga problem, det finns verktyg som gör det åt dig. Där har jag använt Rebelbetting som erbjuder både value betting och sure betting.
